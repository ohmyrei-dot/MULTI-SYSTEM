...
# -----------------------------------------------------------------------------
# 4. [신규] 업체별 매입단가 조회 (컬럼 너비 최적화 + CSS 글자 확대)
# -----------------------------------------------------------------------------
def run_vendor_purchase_system():
    ...
    try:
        ...
        if active_cart and target_vendors:
            ...
            # [수정] 컬럼 너비 설정 (모두 medium으로 통일 또는 규격2와 동일하게)
            col_config = {
